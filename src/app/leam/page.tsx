...
export const metadata: Metadata = {
  title: "לעם — סוויטת פורטלים אזרחיים | זומר עורך דין",
  description:
    "ארבעה פורטלים אזרחיים שמנגישים מידע ציבורי: מידע לעם, גרסאות לעם, יומן לעם וניגוד עניינים לעם. שקיפות, אחריותיות ונגישות מידע.",
  openGraph: {
    title: "לעם — סוויטת פורטלים אזרחיים",
    description:
      "ארבעה פורטלים שמנגישים מידע ציבורי, מבנה גרסאות של מאגרי מידע ממשלתיים, יומן פעילות נבחרי ציבור והסדרי ניגוד עניינים.",
    type: "website",
  },
};
...
const PORTALS: Portal[] = [
  {
    index: "01",
    name: "מידע לעם",
    tagline: "פורטל המידע הפתוח הישראלי",
    description:
      "פלטפורמה שמרכזת אלפי מאגרי מידע מ-49 גופים ציבוריים בישראל ומאפשרת לכל אזרח לחפש, לעיין ולהוריד מידע ממשלתי — מהיסטוריית טיסות ועד רישומי בנייה ירוקה. הבסיס לכל ניתוח ציבורי בלתי-תלוי.",
    domain: "odata.org.il",
    url: "https://www.odata.org.il/",
    icon: Database,
    tags: ["מידע פתוח", "CKAN", "API ציבורי", "49 גופים"],
  },
  {
    index: "02",
    name: "גרסאות לעם",
    ...
    icon: History,
    tags: ["diff", "data.gov.il", "שקיפות לאורך זמן"],
  },
  {
    index: "03",
    name: "יומן לעם",
    ...
    icon: Calendar,
    tags: ["נבחרי ציבור", "timeline", "אחריותיות"],
  },
  {
    index: "04",
    ...
    icon: Network,
    tags: ["graph", "ניגוד עניינים", "מיפוי קשרים"],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-5 p-6 sm:p-8">
        ...
        {/* Domain bar — looks like a terminal prompt */}
        <div
          className={cn(
        ...
        {/* Tags */}
        <div className="flex flex-wrap gap-1.5" aria-label="תגיות">
          {portal.tags.map((tag) => (
            <span
              key={tag}
              className={cn(
                "inline-block rounded-md border border-white/10 bg-white/[0.04] px-2 py-0.5",
        ...
        <div className="pt-1">
          <Link
            ...
            className={cn(
              ...
              "border border-accent/50 bg-accent/10 px-4 py-2",
            ...
            aria-label={`פתחו את ${portal.name} (נפתח בכרטיסייה חדשה)`}
          >
            <span>פתחו את הפורטל</span>
    ...
    <PublicLayout>
      ...
      >
        ...
        <Container className="relative py-20 sm:py-28">
          {/* Top meta strip */}
          <div className="mx-auto mb-10 flex max-w-fit items-center gap-3 rounded-full border border-white/15 bg-white/[0.04] px-4 py-1.5 backdrop-blur-sm">
            <span
              aria-hidden="true"
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/80 sm:text-xl">
              סוויטה של ארבעה פורטלים אזרחיים שמנגישים מידע ציבורי בישראל —
              <br className="hidden sm:block" />
              מאגרי מידע, גרסאות, יומני נבחרים והסדרי ניגוד עניינים.
            </p>

            {/* Counter strip */}
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-2 gap-px overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] sm:grid-cols-4">
              {[
                { k: "04", v: "פורטלים" },
                ...
                <div
                  key={stat.v}
                  className="bg-primary-dark/40 px-4 py-4 text-center"
                >
                  <div className="font-mono text-2xl font-bold text-accent-light sm:text-3xl">
                    {stat.k}
                  </div>
                  <div className="mt-1 text-xs text-white/60">{stat.v}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      >
        ...
        <Container className="relative">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-loose text-white/75 sm:text-lg">
              ארבעת הפורטלים שלהלן נבנו מתוך תפיסה אחת: שמידע ציבורי הוא קודם
              כל שלנו. כל פורטל מטפל בשכבה אחרת של הפער בין המידע שגופי הציבור
              מחזיקים לבין המידע שאזרחים יכולים בפועל להגיע אליו, להבין ולהשתמש
              בו — מהקובץ הגולמי ועד גרף הקשרים בין נושאי המשרה.
            </p>
          </div>
        </Container>
      </section>
      ...
      >
        ...
        <Container className="relative">
          ...
          <div className="mb-12 text-center">
            <span className="font-mono text-xs uppercase tracking-[0.3em] text-accent-light">
              {"// הפורטלים"}
            </span>
            <h2
        ...
        <Container className="relative">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base leading-relaxed text-white/75">
              סוויטת לעם פתוחה לשיתופי פעולה עם חוקרים, עיתונאים, ארגוני חברה
              אזרחית ופיתוח עצמאי. אם יש לכם רעיון להמשך — כתבו לנו.
            </p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <Link
                ...
                className={cn(
                  "inline-flex items-center gap-2 rounded-lg",
                  "border border-white/20 bg-white/[0.04] px-6 py-3",
                  "text-base font-semibold text-white transition-all duration-200",
                  "hover:bg-white/[0.08] hover:border-white/40",
                )}
              >
