...
export const metadata: Metadata = {
  title: "מדיה",
  description:
    "ראיונות, הרצאות והופעות מדיה של עו\"ד זומר. סיקור תקשורתי, כנסים מקצועיים ופרסומים בתחום המשפט.",
  openGraph: {
    title: "מדיה | עו\"ד זומר",
    description:
      "ראיונות, הרצאות והופעות מדיה של עו\"ד זומר.",
  },
};
