...
export const metadata: Metadata = {
  ...
  description:
    "מדיניות הפרטיות של משרד עורכי דין זומר. מידע על איסוף, שימוש ושמירה על נתונים אישיים.",
  openGraph: {
    title: "מדיניות פרטיות | זומר - משרד עורכי דין",
    description:
      "מדיניות הפרטיות של משרד עורכי דין זומר.",
  },
};
...
const PRIVACY_SECTIONS: readonly PrivacySection[] = [
  {
    ...
    title: "כללי",
    content: [
      "משרד עורכי דין זומר (להלן: \"המשרד\") מכבד את פרטיות המשתמשים באתר האינטרנט שלו. מדיניות פרטיות זו מתארת כיצד אנו אוספים, משתמשים ומגנים על המידע האישי שלכם.",
      "השימוש באתר מהווה הסכמה למדיניות פרטיות זו. אנו ממליצים לקרוא מדיניות זו בעיון לפני השימוש באתר.",
  ...
  },
  {
    ...
    title: "איסוף מידע",
    content: [
      "אנו אוספים מידע שאתם מספקים לנו ישירות, כגון בעת מילוי טופס יצירת קשר, שליחת פנייה או הרשמה לניוזלטר.",
    ],
    subsections: [
      {
        ...
        content: [
          ...
          "תוכן ההודעות והפניות שנשלחות אלינו דרך האתר.",
          "כל מידע נוסף שתבחרו לשתף עמנו במסגרת התקשרות מקצועית.",
        ],
      },
      {
    ...
    subsections: [
      {
        ...
        content: [
          ...
          "מתן שירותים משפטיים מקצועיים ללקוחותינו.",
  ...
  },
  {
    ...
    title: "שיתוף מידע",
    content: [
      "המשרד לא ימכור, ישכיר או יעביר את המידע האישי שלכם לצדדים שלישיים, אלא במקרים הבאים:",
    ],
    subsections: [
      {
        ...
        content: [
          ...
          "לספקי שירותים חיוניים הפועלים בשמנו (כגון שירותי אחסון אתרים), הכפופים להתחייבויות סודיות.",
        ],
      },
    ],
  },
  {
    ...
    title: "אבטחת מידע",
    content: [
      "אנו נוקטים באמצעי אבטחה סבירים ומקובלים כדי להגן על המידע האישי שלכם מפני גישה בלתי מורשית, אובדן או שימוש לרעה.",
      "האתר מאובטח באמצעות פרוטוקול SSL/TLS להצפנת תעבורת נתונים.",
      "הגישה למידע אישי מוגבלת לצוות המורשה בלבד.",
      "יחד עם זאת, אין שיטת אבטחה מושלמת ואיננו יכולים להבטיח אבטחה מוחלטת של המידע.",
    ],
  },
  {
    id: "rights",
    ...
    subsections: [
      {
        title: "זכויותיכם",
        content: [
          "הזכות לעיין במידע האישי השמור אודותיכם במאגרי המשרד.",
  ...
  },
  {
    ...
    title: "יצירת קשר",
    content: [
      "לכל שאלה, בקשה או תלונה בנוגע למדיניות הפרטיות שלנו, ניתן לפנות אלינו באחת מהדרכים הבאות:",
      "דואר אלקטרוני: privacy@zomer-law.co.il",
      "טלפון: 03-000-0000",
      "כתובת: רחוב הברזל 30, תל אביב",
      "אנו מתחייבים לטפל בכל פנייה תוך 30 ימי עסקים.",
    ],
  },
] as const;
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/80">
              המשרד מחויב להגנה על פרטיותכם ולשמירה על המידע האישי שלכם בהתאם
              לחוק הגנת הפרטיות.
            </p>
          </div>
        </Container>
