...
export const DEFAULT_PROJECTS_CONTENT: ProjectsPageContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "דשבורד אינטראקטיבי המרכז את הסדרים המותנים שפרסמה המשטרה והפרקליטות — מעל 33,000 הסדרים ממאגרי הממשלה, עם יכולות חיפוש AND (כמה מילים יחד), סינון לפי מחוז, יחידה, עבירה וטווח תאריכים. הנתונים מתעדכנים אוטומטית מ-odata.org.il.",
