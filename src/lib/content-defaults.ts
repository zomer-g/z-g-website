...
export const DEFAULT_PROJECTS_CONTENT: ProjectsPageContent = {
  ...
  projects: [
    ...
    {
      title: "גרסאות לעם",
      subtitle: "מעקב גרסאות אחרי מאגרי מידע ממשלתיים פתוחים",
      description: "כלי שמתעד את ההיסטוריה של מאגרי המידע הממשלתיים ב-data.gov.il וב-gov.il — כל פעם שמאגר מתעדכן, נוספים או נגרעים משאבים, או שמשתנה הקובץ עצמו. הפלטפורמה מאפשרת לעקוב אחרי מאגרים, להשוות בין גרסאות ולזהות שינויים שקטים בנתונים שמתפרסמים לציבור — ובכך הופכת את השקיפות הממשלתית לאחריותית גם לאורך זמן, ולא רק ברגע הפרסום הראשוני.",
      url: "https://www.over.org.il/",
      icon: "History",
      tags: ["מעקב גרסאות", "data.gov.il", "שקיפות לאורך זמן"],
    },
    {
      title: "יומן לעם",
