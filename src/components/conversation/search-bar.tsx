      ...
      <div className="flex items-center gap-2">
        ...
        {onBack ? (
          <button
            ...
            className="inline-flex shrink-0 items-center justify-center h-9 w-9 rounded-full hover:bg-black/5 text-gray-700 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-1"
          >
        ...
        <label className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-full bg-[#f0f2f5] border border-transparent ps-7 pe-3 py-1.5 text-sm text-gray-900 placeholder:text-gray-600 focus-visible:border-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-200"
          />
        </label>
                      ...
                      <li key={t.id}>
                        <button
                          ...
                          className={cn(
                            ...
                            "focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-inset",
        ...
        {hasFilter ? (
          <button
            ...
            className="flex items-center gap-1 text-xs text-gray-700 hover:text-gray-900 rounded-md px-2 py-1 hover:bg-gray-100 shrink-0 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-1"
          >
